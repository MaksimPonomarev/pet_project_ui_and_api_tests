...
def test_open_brand_products(main_page):
    main_page.open()
    ...
    main_page.sidebar.should_be_brand_products_page(brand=Brands.POLO)

    main_page.sidebar.open_brand_page(brand=Brands.ALLEN_SOLLY_JUNIOR)
    main_page.sidebar.should_be_brand_products_page(brand=Brands.ALLEN_SOLLY_JUNIOR)