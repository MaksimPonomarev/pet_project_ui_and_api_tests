...
def test_open_category_products(main_page):
    main_page.open()
    ...
    main_page.sidebar.should_be_subcategory_products_page(subcategory=WomenSubcategory.DRESS)
    ...
    main_page.sidebar.should_be_subcategory_products_page(subcategory=MenSubcategory.TSHIRTS)